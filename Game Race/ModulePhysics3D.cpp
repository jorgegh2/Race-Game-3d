...
PhysVehicle3D* ModulePhysics3D::AddVehicle(const VehicleInfo& info)
{
	...
	btCollisionShape* colShape = new btBoxShape(btVector3(info.cube1.x*0.5f, info.cube1.y*0.5f, info.cube1.z*0.5f));
	shapes.add(colShape);

	btTransform trans;
	trans.setIdentity();
	trans.setOrigin(btVector3(info.cube1_offset.x, info.cube1_offset.y, info.cube1_offset.z));
